...
public class ListViewAdapterOrder extends BaseAdapter {
    ...
    public ListViewAdapterOrder(Activity context, ArrayList<String> order_id,  ArrayList<String> item,  ArrayList<String> quantity, ArrayList<String> order_time,int arraysize) {
        super();
